...
List your phone(s) in the "case" region in the s60v3-tether script (three examples are given in the script): you need to provide in each case a name, the bluetooth address, and the dial-up channel. In order to find the bluetooth address of the phone you can use "hcitool scan"; then use "sdptool browse bluetooth_address" to find the corresponding dial-up channel.
